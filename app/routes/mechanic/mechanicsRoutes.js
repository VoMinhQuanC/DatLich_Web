...
// Lịch nhóm (Calendar)
router.get('/schedules/team/by-date-range/:startDate/:endDate', authenticateToken, mechanicController.getTeamSchedules);
...
router.get('/leave-requests/stats', authenticateToken, mechanicController.getLeaveRequestStats);
